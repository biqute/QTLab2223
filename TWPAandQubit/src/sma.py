...
class ManageSMA:
    ...
    def __init__(self, resource):
        ...
        self.max_amplitude = -40    # Max amplitude permitted to the user
        
        self.instr.write_str(':OUTPut1 ON') # Turn ON the OUTPUT   
        pass

    def close(self):
        """Close connection to instrument"""

        self.instr.write_str(':OUTPut1 OFF') # Turn OFF the OUTPUT
        self.instr.close()
