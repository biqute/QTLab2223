...
def measuref(fridge, vna, temps, freqs_ranges, format_data):        #the argument freqs is a matrix, or better an array of arrays, each of which has 2 elements: a start and stop frequency
    '''Outputs two matrices with dimensions num_points vs num_temperatures.
    The first contains the i values while the second contains the q values.'''
